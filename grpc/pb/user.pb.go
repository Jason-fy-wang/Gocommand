...
const file_user_proto_rawDesc = "" +
	...
	"\x03msg\x18\x06 \x01(\tR\x03msg2C\n" +
	"\vUserService\x124\n" +
	"\vGetUserInfo\x12\x11.user.UserRequest\x1a\x12.user.UserResponseB\n" +
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.GetUserInfo:input_type -> user.UserRequest
	1, // 1: user.UserService.GetUserInfo:output_type -> user.UserResponse
